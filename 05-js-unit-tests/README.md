...
O objetivo do projeto foi implementar funções na resolução dos requisitos propostos e/ou testes unitários para garantir a funcionalidade correta das funções.

O projeto foi entregue originalmente no repositório privado da Trybe https://github.com/tryber/sd-023-a-project-js-unit-tests por meio da criação de uma branch pessoal e um Pull Request, onde seus requisitos foram avaliados automaticamente.
